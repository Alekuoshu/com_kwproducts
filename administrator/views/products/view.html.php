...
/**
 * View class for a list of Kwproducts.
 *
 * @since  1.6
 */
class KwproductsViewProducts extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		KwproductsHelper::addSubmenu('products');
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::preferences('com_kwproducts');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_kwproducts&view=products');
	}
